...
/**
 * Provides the shared instance of GMSPlacesClient for the Boobuz Places API for iOS, creating it if
 * necessary.
 *
 ...
 * @param lang The language of the place.
...
// */
//- (void)addPlace:(ERUserAddedPlace *)place
//        callback:(GMSPlaceResultCallback)callback
//__ER_AVAILABLE_BUT_DEPRECATED_MSG(
