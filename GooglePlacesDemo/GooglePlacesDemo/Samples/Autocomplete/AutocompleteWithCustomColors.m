...
- (void)presentAutocompleteControllerWithBackgroundColor:(UIColor *)backgroundColor
  ...
  UIActivityIndicatorView *appearence = [UIActivityIndicatorView
      appearanceWhenContainedIn:[ERStyledAutocompleteViewController class], nil];
  [appearence setColor:primaryTextColor];

  [[UINavigationBar appearanceWhenContainedIn:[ERStyledAutocompleteViewController class], nil]
  ...
  [[UITextField appearanceWhenContainedIn:[ERStyledAutocompleteViewController class], nil]
  ...
  id tableCellAppearance =
      [UITableViewCell appearanceWhenContainedIn:[ERStyledAutocompleteViewController class], nil];
...
- (void)setupSearchBarCustomIcons {
  id searchBarAppearanceProxy =
      [UISearchBar appearanceWhenContainedIn:[ERStyledAutocompleteViewController class], nil];
